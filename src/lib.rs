...
#[derive(Debug)]
pub struct WhisperNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WhisperNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WhisperNet processing");
    
    let mut processor = WhisperNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WhisperNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WhisperNetProcessor::new(false);
